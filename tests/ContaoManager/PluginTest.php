...
namespace MetaModels\AttributeTranslatedLongtextBundle\Test\ContaoManager;

use Contao\CoreBundle\ContaoCoreBundle;
use Contao\ManagerPlugin\Bundle\BundlePluginInterface;
use Contao\ManagerPlugin\Bundle\Config\BundleConfig;
use Contao\ManagerPlugin\Bundle\Parser\ParserInterface;
use MetaModels\AttributeTranslatedLongtextBundle\ContaoManager\Plugin;
 ...
 *
 * @covers \MetaModels\AttributeTranslatedLongtextBundle\ContaoManager\Plugin
 */
class PluginTest extends TestCase
{
    ...
    public function testBundleConfig()
    {
        ...
        $this->assertEquals($bundleConfig->getReplace(), ['metamodelsattribute_translatedlongtext']);
    }
}
